...
<div align="left">
    <p>
        numeric-lang is the FEAT-tier crate: Correct numeric literal parsing: radixes, digit separators, exact float round-trip. Part of the -lang language-construction family; see _strategy/LANG_COLLECTION.md for the master plan.
    </p>
    <br>
    <hr>
    <p>
